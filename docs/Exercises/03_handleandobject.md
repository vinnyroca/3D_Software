...
A good place to start for inspiration is [Sketchfab.com](https://sketchfab.com/). You can use the model inspector to examine the wireframe of models. Use this to examine each artist's approach to topology.
...
1. An image of your completed teapot handle:
2. Two images of your modeled object:
    - One image should have no wireframe.
    - The other image should display your object in shaded wireframe mode.
3. Your completed exercise should be accessible in your server folder.